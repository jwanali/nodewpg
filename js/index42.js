...
console.log('\nThe message in lower case:\n\n',message.toLowerCase());
let text1upper = text1.toUpperCase();
let text2lower = text2.toLowerCase();
text1upper = text1upper.concat(`\n`);
text2lower = text2lower.concat(`\n`);
let bothtext = text1upper.concat(text2lower);
console.log('\n\nboth message:\n\n',bothtext);
console.log('The message has', bothtext.length, 'characters long');